...
class RecipeTest < ActiveSupport::TestCase
  test "creates a valid record" do
    ...
    recipe.instructions = "Combine all ingredients into the galss and let sit for two minutes. Serve immediately."
    assert recipe.save
  end
  ...
  test "should not save unless ingredients is filled in" do
    recipe = Recipe.new
    assert !recipe.save # save should fail also make sure there are no
    # caps after the include.
